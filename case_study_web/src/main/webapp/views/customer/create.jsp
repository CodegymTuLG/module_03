...
<div class="col-9"> <h1>CREATE NEW CUSTOMER</h1><br>
    <form action="/customer?action=create" method="post" class="row g-3" style="width: 95%">
        <div class="col-md-6">
        ...
        <div class="col-md-4">
            ...
            <select name="customertype_id" class="form-select">
                <c:forEach var="customertypemaster" items="${customerTypeMasters}" varStatus="status">
                    <option value="${customertypemaster.customertype_id}">${customertypemaster.type}</option>
                </c:forEach>
            </select>
        </div>
