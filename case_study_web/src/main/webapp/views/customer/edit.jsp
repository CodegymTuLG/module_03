...
<nav class="row navbar navbar-expand-lg navbar-light bg-info" style="height: 7%">
    <div class="container-fluid">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
            ...
            <li class="nav-item">
                <a class="navbar-brand" href="/customer">Employee</a>
            </li>
            <li class="nav-item">
...
<div class = "row" style="height: 81%">
    ...
    <%--Show page edt customer--%>

    <div class="col-9"> <h1>EDIT CUSTOMER</h1><br>
        <form action="/customer?action=update" method="post" class="row g-3" style="width: 95%">
            <input type="hidden" name="customer_id" value="<c:out value="${customer.getCustomer_id()}"></c:out>">
            <div class="col-md-6">
                <label class="form-label">Customer name</label>
                <input type="text" class="form-control" name="name" value="<c:out value="${customer.getName()}"></c:out> ">
            </div>
            <div class="col-md-2">
                <label class="form-label">Birth day</label>
                <input type="date" class="form-control" name="birthday" value="<c:out value="${customer.getBirthday()}"></c:out>">
            </div>
            <div class="col-md-2">
                <label class="form-label">Card Id</label>
                <input type="text" class="form-control" name="cardid" value="<c:out value="${customer.getCardid()}"></c:out>">
            </div>

            <div class="col-md-4">
                <label class="form-label">Phone number</label>
                <input type="number" class="form-control" name="phonenumber" value="<c:out value="${customer.getPhonenumber()}"></c:out>">
            </div>
            <div class="col-md-4">
                <label class="form-label">Email</label>
                <input type="text" class="form-control" name="email" value="<c:out value="${customer.getEmail()}"></c:out>">
            </div>
            <div class="col-md-4">
                <label class="form-label">Address</label>
                <input type="text" class="form-control" name="address" value="<c:out value="${customer.getAddress()}"></c:out>">
            </div>
